...
class NPackBB(BBG):
    ...
    def generateBuildingBlock(self, numPoints, minDist, envelopeList='[None]', pointsToAvoid=[], visualiseEnvelope=(0,200,'envelope.xyz'), showBlockDirector=False, defaultBlockRefPoint=None):
