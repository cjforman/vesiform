...
if __name__=="__main__":
    ...
    numPolymersPerCylinder =  600 #430
    CZ1 = 0
    CZ2 = 300
    UnimerBaseRadius = 6
    CylRadius = 0.25 * (backboneDict1['Z2'] + backboneDict2['Z2'] - backboneDict1['Z1'] - backboneDict2['Z1'])
    phiMin = -180
    phiMax = 180    
    ...
    Polymer1CylinderBB = CylinderBBG.generateBuildingBlock(numPolymersPerCylinder, CylRadius, CylRadius, CZ1, CZ2, phiMin, phiMax, UnimerBaseRadius)
    ...
    basePoints = [ coords.cyl2XYZ(np.array([CylRadius, pos[1], pos[2]])) for pos in Polymer1CylinderPointsCylCoords ]

    # set up the frustum to start on the inner surface
    polymerStartPoint = np.array([0.0, 0.0, CylRadius])
    ...
    fIO.saveXYZList(xyzValsList, allNames, "polymerCylinder.xyz")
